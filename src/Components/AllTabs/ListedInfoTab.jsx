...
const ListedInfoTab = ({ prevStep, nextStep }) => {
  return (
    <>
      <div>
          ...
          <div className="card-body pt-0">
            <div className="d-flex flex-wrap gap-5 mb-10">
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  ...
                  <input type="text" className="form-control" value="244.00" />
                </div>
              </div>
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  <input type="text" className="form-control" value="1.21" />
                  <span className="input-group-text">%</span>
                </div>
              </div>
            </div>
            <div className="d-flex flex-wrap gap-5 mb-10">
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <input type="text" className="form-control" value="543725" />
              </div>
            </div>
            <div className="d-flex flex-wrap gap-5 mb-10">
              <div className="w-100 fv-row flex-md-root">
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  <span className="input-group-text">₹</span>
                  <input type="text" className="form-control" value="228.10" />
                </div>
              </div>
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  <input type="text" className="form-control" value="7.7" />
                  <span className="input-group-text">%</span>
                </div>
              </div>
            </div>
            <div className="d-flex flex-wrap gap-5 mb-10">
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  <span className="input-group-text">₹</span>
                  <input type="text" className="form-control" value="245.00" />
                </div>
              </div>
              ...
              <div className="w-100 fv-row flex-md-root">
                ...
                <div className="input-group">
                  <span className="input-group-text">₹</span>
                  <input type="text" className="form-control" value="217.70" />
                </div>
              </div>
            </div>
          </div>
